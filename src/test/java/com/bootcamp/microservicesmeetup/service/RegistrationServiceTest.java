...
import com.bootcamp.microservicesmeetup.service.impl.RegistrationServiceImpl;
...
public class RegistrationServiceTest {
    ...
    // antes de cada test roda-se a dependencia no service
    @BeforeEach
    public void setUp() {
        // dependencia do service + new
    ...
    public void saveStudent() {
        ...
        assertThat(savedRegistration.getName()).isEqualTo("Ana");
    ...
    public void getByRegistrationById() {
    ...
    @Test
    @DisplayName("Should get an Registration model by registration atribute")
    ...
    // tudo que criamos de metodo em uma clase, criamos private
